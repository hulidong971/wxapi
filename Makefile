...
LDFLAGS =	-s
LDLIBS =	$(CRYPT_LIB) $(SSL_LIBS) $(SYSV_LIBS) -lcurl

all:		mini_httpd

mini_httpd: mini_httpd.o match.o tdate_parse.o wxapi.o cjson.o
	$(CC) $(LDFLAGS) mini_httpd.o match.o tdate_parse.o wxapi.o cjson.o -o mini_httpd $(LDLIBS)
